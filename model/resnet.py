...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, need_fc=False, num_classes=1000):
        self.inplanes = 64
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(output_size=(1, 1))  # for 448*448
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], need_fc=False)
    if pretrained:
